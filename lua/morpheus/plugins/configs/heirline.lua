return function(_, opts)
  ...
  local C = require("morpheus.utils.status.env").fallback_colors
  local get_hlgroup = require("morpheus.utils").get_hlgroup
  local lualine_mode = require("morpheus.utils.status.hl").lualine_mode
  ...
  local function setup_colors()
    ...
    local colors = morpheus.user_opts("heirline.colors", {
      close_fg = Error.fg,
      fg = StatusLine.fg,
      bg = StatusLine.bg,
