...
--
-- This module can be loaded with `local astro_heirline = require "morpheus.utils.status.heirline"`
--
-- @module morpheus.utils.status.heirline
-- @copyright 2023
...
M.make_buflist = function(component)
  ...
  return require("heirline.utils").make_buflist(
    ...
    function() return vim.t.bufs or {} end, -- use morpheus bufs variable
