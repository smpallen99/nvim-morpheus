...
--
-- This module can be loaded with `local env = require "morpheus.utils.status.env"`
--
-- @module morpheus.utils.status.env
-- @copyright 2023
...
M.separators = morpheus.user_opts("heirline.separators", {
  none = { "", "" },
  left = { "", "  " },
  right = { "  ", "" },
  center = { "  ", "  " },
...
M.attributes = morpheus.user_opts("heirline.attributes", {
...
M.icon_highlights = morpheus.user_opts("heirline.icon_highlights", {
  file_icon = {
...
M.sign_handlers = morpheus.user_opts("heirline.sign_handlers", M.sign_handlers)
