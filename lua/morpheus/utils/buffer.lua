...
--
-- This module can be loaded with `local buffer_utils = require "morpheus.utils.buffer"`
--
-- @module morpheus.utils.buffer
-- @copyright 2022
...
---@param compare_func string|function a string of a comparator defined in require("morpheus.utils.buffer").comparator or a custom comparator function
...
local function unique_path(bufnr)
  return require("morpheus.utils.status.provider").unique_path() { bufnr = bufnr }
