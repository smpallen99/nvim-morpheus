...
--
-- This module can be loaded with `local ui = require("morpheus.utils.ui")`
--
-- @module morpheus.utils.ui
-- @see morpheus.utils
-- @copyright 2022
...
local function ui_notify(silent, ...) return not silent and require("morpheus.utils").notify(...) end
...
function M.toggle_diagnostics(silent)
  ...
  vim.diagnostic.config(require("morpheus.utils.lsp").diagnostics[vim.g.diagnostics_mode])
...
function M.toggle_url_match(silent)
  ...
  require("morpheus.utils").set_url_match()
